...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String playerAttack = JOptionPane
					.showInputDialog("Do you want to attack the dragon with a yell or a kick?");
			// 9. If they typed in "yell":
			if (playerAttack.equalsIgnoreCase("yell")) {

				// -- Find a random number between 0 and 10 and store it in dragonDamage
				damagePlayer = new Random().nextInt(10);
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - damagePlayer;
			}
			...
			damageDragon = new Random().nextInt(35);
			// 12. Subtract this number from the player's health
			playerHealth = playerHealth - damageDragon;
			...
			JOptionPane.showMessageDialog(null,
					"Your health is " + playerHealth + " and you dealt " + damagePlayer
							+ " damage. The dragon's health is " + dragonHealth + ", and he dealt " + damageDragon
							+ " damage.");
